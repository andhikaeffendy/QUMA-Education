        ...
        <section id="about">
            <div class="container">
                <div class="row">
                    ...
                    $pertanyaan = array(
		0 => array(
			'soal' => 'Unsur Y dalam sistem periodik unsur modern terletak pada ….',
		 	'pilihan' => 'A. Perioda 2 dan golongan II A |B. Perioda 2 dan golongan IV A |C. Perioda 2 dan golongan VI A |D. Perioda 3 dan golongan II A ',
		 	'jawaban' => 'C'
		),
		1 => array(
			'soal' => 'Gaya London terdapat pada antar molekul senyawa ….',
		 	'pilihan' => 'A. NH3 |B. H2O |C. HCl |D. N2 cair ',
		 	'jawaban' => 'D'
		),
		2 => array(
			'soal' => 'Nama yang tepat untuk senyawa N2O adalah ….',
			'pilihan' => 'A. Nitrogen oksida |B. Nitrogen (I) oksida  |C. Nitrogen (II) oksida |D. Nitrogen (III) oksida',
			'jawaban' => 'B'
		),
		3 => array(
			'soal' => 'Pada konsentrasi yang sama, larutan yang menghantarkan listrik paling baik adalah ….',
			'pilihan' => 'A. HCl |B. CH3COOH |C. HF |D. NH4OH',
			'jawaban' => 'A'			
		)
...
if(isset($_GET['pilihan'])) {
	...
	foreach($_GET['pilihan'] as $a => $b) 
		...
		if(substr($b, 0, 1) == $pertanyaan[$a]['jawaban']) 
            ...
            $query = "INSERT INTO skor(id_skor, username, mata_pelajaran, skor) VALUES ('','$user_quiz','Kimia SMA','$total')";
