        ...
        <section id="about">
            <div class="container">
                <div class="row">
                    ...
                    $pertanyaan = array(
		0 => array(
			'soal' => 'Banyak bilangan ratusan dan ganjil yang dapat di bentuk dari angka-angka 2,3,4, 5,6,7,8 dengan
syarat tak ada pengulangan angka ada......',
		 	'pilihan' => 'A. 36 |B. 48 |C. 60 |D. 90',
		 	'jawaban' => 'A'
		),
		1 => array(
			'soal' => 'Akar-akar persamaan 18 3 12 0
2
x  x  m   adalah α dan β . Jika   5 , maka nilai m adalah ...',
		 	'pilihan' => 'A. 5
 |B. 9 |C. 11 |D. 14 ',
		 	'jawaban' => 'C'
		),
		2 => array(
			'soal' => 'Jika grafik fungsi 1
2
f(x)  x  x  menyinggung garis 3x  y  1 dan p  0 . Maka nilai p yang memenuhi
adalah ...',
			'pilihan' => 'A. 5 |B. 2  |C. –2 |D. –4 ',
			'jawaban' => 'A'
		),
		3 => array(
			'soal' => 'Diketahui prisma segitiga tegak ABC.DEF. Panjang rusuk-rusuk alas AB = 5 cm dan AC = 8 cm dan
Panjang rusuk tegak AD 10 cm. Jika diketahui
Volum prisma tersebut 100 3 adalah ...
',
			'pilihan' => 'A. 6 cm  |B. 6 2 cm |C. 7 cm |D. 7 cm',
			'jawaban' => 'C'			
		),
		4 => array(
			'soal' => 'Diketahui kubus ABCD.EFGH, panjang rusuk kubus 10 cm. Titik P dan Q masing-masing terletak
ditengah-tengah rusuk AB dan AF. Jarak titik C dengan bidang DPQH adalah ...',
			'pilihan' => 'A. 3 5 cm |B. 4 5 cm |C. 5 3 cm |D. 6 3 cm',
			'jawaban' => 'B'			
		)
...
if(isset($_GET['pilihan'])) {
	...
	foreach($_GET['pilihan'] as $a => $b) 
		...
		if(substr($b, 0, 1) == $pertanyaan[$a]['jawaban']) 
            ...
            $query = "INSERT INTO skor(id_skor, username, mata_pelajaran, skor) VALUES ('','$user_quiz','Matematika SMA','$total')";
			...
			echo "
				<script type='text/javascript'>
					...
					if(jwb) {
						window.location ='matematika_sma.php';
					} else {
